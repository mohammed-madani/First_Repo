...
_fvd_speed_dial_LastTab = function( gBrowser ){
    ...
    var loadListener = function(event){
		...
		try{
	        ...
	        if (oneTab && emptyTab) {
	        	self.gBrowser.contentDocument.location = "chrome://quick_start/content/index.html";
	        }
    ...
    function refresh(){
        ...
        if (currentState) {
			...
			try{
				if( browserRoot.getCharPref( "newtab.url" ) == "chrome://quick_start/content/index.html" ){
