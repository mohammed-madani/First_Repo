...
var fvd_speed_dial_gFVDSSDSettings = {		
	sdHomePage: "chrome://quick_start/content/index.html",
	...
	SETTINGS_KEY_BRANCH: 'extensions.quick_start.',
	...
	displayWindow: function( pane, subpane, evaluate, opener ){
		...
		try{		
			...
			while( windows.hasMoreElements() ){
				...
				if( window.document.location == "chrome://quick_start/content/fvd_settings.xul" ){
					// already opened
					window.focus();
	...
	relativeName: function( name ){
		return name.replace( "extensions.quick_start.", "" );
	}
